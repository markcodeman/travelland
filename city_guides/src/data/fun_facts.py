"""
Fun Facts Database - Centralized city-specific information
Separated from app.py for better maintainability
"""

# City-specific fun facts for distinctive category generation
FUN_FACTS = {
    'paris': [
        "The Eiffel Tower was originally intended to be temporary and was almost dismantled in 1909!",
        "Paris has the most visited museum in the world - the Louvre with over 10 million visitors annually!",
        "The city's subway system (Métro) has 16 lines and is one of the densest in the world!",
        "Paris was originally called Lutetia when it was a Roman settlement over 2,000 years ago!",
        "The city has over 6,000 streets and each arrondissement has its own unique character and charm!"
    ],
    'london': [
        "The Tower of London houses the Crown Jewels worth over £20 billion!",
        "London's Big Ben is actually the name of the bell, not the clock tower!",
        "The city has over 170 museums, many of which are free to visit!",
        "London Underground is the world's oldest underground railway system, opened in 1863!",
        "The city was founded by the Romans as Londinium in AD 43 and has been continuously inhabited ever since!"
    ],
    'new york': [
        "New York City has over 800 languages spoken, making it the most linguistically diverse city in the world!",
        "Central Park is larger than Monaco and was designed by Frederick Law Olmsted and Calvert Vaux!",
        "The New York City subway system has 472 stations, the most of any metro system in the world!",
        "Times Square is named after the New York Times building, which moved there in 1904!",
        "The city was originally called New Amsterdam when it was a Dutch colony until 1664!"
    ],
    'tokyo': [
        ...
        "The city's Tsukiji Fish Market is the largest wholesale fish and seafood market in the world!",
        "Tokyo was originally called Edo and was renamed Tokyo in 1868 when it became Japan's capital!"
    ],
    ...
    'navi mumbai': [
        "Navi Mumbai is India's largest planned city with over 1.2 million residents!",
        "The city was developed in 1972 to decongest Mumbai and has world-class infrastructure!",
        "Navi Mumbai has the largest container port in India - Jawaharlal Nehru Port Trust!",
        "The city features the Nerul Balaji Temple, one of the most visited religious sites in Maharashtra!",
        "Navi Mumbai's Vashi node is a major commercial hub with modern business districts!"
    ],
    ...
    #
            ...
            'abu dhabi': [
                "Abu Dhabi's Sheikh Zayed Grand Mosque features 82 domes and the world's largest hand-woven carpet!",
                "Yas Island is home to Ferrari World - the world's largest Ferrari theme park with the fastest roller coaster!",
                "The Emirates Palace hotel costs $3 billion to build and uses 1,002 chandeliers and 6,000 square meters of gold leaf!",
                "Abu Dhabi is the capital of the UAE and sits on an island with beautiful Arabian Gulf beaches!",
                "The city practices traditional falconry - falcons are so valued they have their own passports!"
            ],
            'auckland': [
                "Auckland's Sky Tower is the Southern Hemisphere's tallest structure at 328 meters high!",
                "The city is built on 53 volcanic cones, earning it the nickname 'City of Volcanoes'!",
                "Auckland has more boats per capita than any other city in the world - it's called the 'City of Sails'!",
                "Nearby Hobbiton movie set from Lord of the Rings attracts thousands of fans daily!",
                "The region is home to over 100 wineries, particularly known for Pinot Noir and Chardonnay!"
            ],
            'singapore': [
            ...
            'edinburgh': [
                "Edinburgh Castle sits on an extinct volcano and is home to the Scottish Crown Jewels!",
                "The city hosts the world's largest arts festival - the Edinburgh Festival Fringe with over 3,000 shows!",
                "The Royal Mile is a historic street connecting Edinburgh Castle to Holyroodhouse Palace!",
                "Edinburgh's Old Town and New Town are both UNESCO World Heritage Sites!",
                "The city invented many famous things including golf, whiskey, and Harry Potter inspiration!"
            ],
            'dublin': [
                "Dublin's Guinness Storehouse is Ireland's most popular attraction with over 1.7 million visitors annually!",
                "The city has over 1,000 pubs - one for every 1,000 residents!",
                "Trinity College Dublin is Ireland's oldest university, founded in 1592 and home to the Book of Kells!",
                "Dublin Castle was built in the 13th century and served as British headquarters until 1922!",
                "The Ha'penny Bridge is Dublin's oldest pedestrian bridge crossing the River Liffey!"
            ],
            'lisburn': [
                "Lisburn is known as Northern Ireland's Cathedral City and became a city in 2002!",
                "The city has the world's oldest linen market, dating back to the 17th century!",
                "Lisburn Castle was built in the 1600s and is a historic landmark in the city center!",
                "The city hosts the popular Lisburn Festival which celebrates local culture and music!",
                "Lisburn is home to the Irish Linen Centre and Museums showcasing the region's textile heritage!"
            ],
            'dundonald': [
                "Dundonald is home to the historic Dundonald Castle, built by the Normans in the 12th century!",
                "The town has the Ice Bowl - Northern Ireland's premier ice hockey and skating venue!",
                "Dundonald International Park hosts major concerts and events throughout the year!",
                "The area has ancient hillforts dating back to the Iron Age!",
                "Dundonald is famous for its excellent transport links to Belfast and George Best Belfast City Airport!"
            ],
            'bilbao': [
                "Bilbao is home to the iconic Guggenheim Museum, a masterpiece of contemporary architecture!",
                "The city has the world's oldest transporter bridge, the Vizcaya Bridge, dating back to 1893!",
                "Bilbao's Casco Viejo (Old Town) features seven medieval streets and traditional Basque architecture!",
                "The city is famous for its pintxos (Basque tapas) culture with over 400 bars serving delicious small plates!",
                "Bilbao has been transformed from an industrial port to a vibrant cultural hub since the 1990s!"
            ],
            'santutxu': [
                "Santutxu is a vibrant district in Bilbao known for its traditional Basque neighborhood atmosphere!",
                "The area features the iconic Santutxu Market, one of the most popular markets in Bilbao!",
                "Santutxu has excellent metro connections making it easy to explore the rest of Bilbao!",
                "The district is famous for its local festivals and strong community spirit!",
                "Santutxu offers stunning views of the surrounding Basque mountains and coastline!"
            ],
...
def get_fun_facts():
    """Get all fun facts dictionary"""
    return FUN_FACTS

def get_city_fun_facts(city: str) -> list:
    """Get fun facts for a specific city"""
    city_lower = city.lower().strip()
    return FUN_FACTS.get(city_lower, [])

def add_city_fun_facts(city: str, facts: list) -> None:
    """Add or update fun facts for a city"""
    city_lower = city.lower().strip()
    FUN_FACTS[city_lower] = facts
