...
city_mappings = {
    ...
    'lisburn': {'city': 'Lisburn', 'country': 'GB', 'countryName': 'United Kingdom', 'state': 'Northern Ireland', 'stateName': 'Northern Ireland'},
    'dundonald': {'city': 'Dundonald', 'country': 'GB', 'countryName': 'United Kingdom', 'state': 'Northern Ireland', 'stateName': 'Northern Ireland'},
    'bilbao': {'city': 'Bilbao', 'country': 'ES', 'countryName': 'Spain', 'state': 'Basque Country', 'stateName': 'Basque Country'},
    'santutxu': {'city': 'Santutxu', 'country': 'ES', 'countryName': 'Spain', 'state': 'Basque Country', 'stateName': 'Basque Country'},
    'cartagena': {'city': 'Cartagena', 'country': 'CO', 'countryName': 'Colombia'},
    'chiba': {'city': 'Chiba', 'country': 'JP', 'countryName': 'Japan'},
    'balaka': {'city': 'Balaka', 'country': 'MW', 'countryName': 'Malawi'},
    ...
    'navi mumbai': {'city': 'Navi Mumbai', 'country': 'IN', 'countryName': 'India', 'state': 'MH', 'stateName': 'Maharashtra'},
    'bangkok': {'city': 'Bangkok', 'country': 'TH', 'countryName': 'Thailand'},
    'kolkata': {'city': 'Kolkata', 'country': 'IN', 'countryName': 'India', 'state': 'WB', 'stateName': 'West Bengal'},
    'cairo': {'city': 'Cairo', 'country': 'EG', 'countryName': 'Egypt'},
    'istanbul': {'city': 'Istanbul', 'country': 'TR', 'countryName': 'Turkey'},
    'budapest': {'city': 'Budapest', 'country': 'HU', 'countryName': 'Hungary'},
    'prague': {'city': 'Prague', 'country': 'CZ', 'countryName': 'Czech Republic'},
    ...
    'barcelona': {'city': 'Barcelona', 'country': 'ES', 'countryName': 'Spain', 'state': 'CT', 'stateName': 'Catalonia'},
    'rome': {'city': 'Rome', 'country': 'IT', 'countryName': 'Italy'},
    'venice': {'city': 'Venice', 'country': 'IT', 'countryName': 'Italy', 'state': 'VE', 'stateName': 'Veneto'},
    'athens': {'city': 'Athens', 'country': 'GR', 'countryName': 'Greece'},
'vienna': {'city': 'Vienna', 'country': 'AT', 'countryName': 'Austria'},
'madrid': {'city': 'Madrid', 'country': 'ES', 'countryName': 'Spain'},
'barcelona': {'city': 'Barcelona', 'country': 'ES', 'countryName': 'Spain', 'state': 'CT', 'stateName': 'Catalonia'},
